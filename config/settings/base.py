...
CHAT_BUTTON_ID = env.str('CHAT_BUTTON_ID', '5731L000000M5rP')
CHAT_DEPLOYMENT_ID = env.str('CHAT_DEPLOYMENT_ID', '5721L000000M4Hq')
CHAT_ORG_ID = env.str('CHAT_ORG_ID', '00DG0000000gEcp')
