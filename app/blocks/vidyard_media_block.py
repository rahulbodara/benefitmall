...
class MediaBlock(StructBlock):
    ...
    video_id = CharBlock(required=False, label='Video ID', help_text='Enter the video source ID from Vidyard. Should only consist of alphanumeric characters. Ex: 86036070')
    ...
    class Meta:
        template = 'blocks/vidyard_media_block.html'
        icon = 'fa-image'
