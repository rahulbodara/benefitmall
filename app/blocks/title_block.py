...
class TitleBlock(StructBlock):
    ...
    switchable = CustomChoiceBlock(choices=SWITCHABLE_CHOICES, required=False, default=SWITCHABLE_CHOICES[0][0], widget=CustomRadioSelect)
    text = MultiTextBlock()
    ...
    class Meta:
        ...
        label = 'Title'
        form_classname = 'title-block struct-block'
