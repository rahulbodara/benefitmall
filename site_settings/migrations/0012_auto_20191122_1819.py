# Generated by Django 2.2.7 on 2019-11-22 18:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='sitesettings',
            name='pwa_icon_large',
            field=models.ForeignKey(blank=True, help_text='This icon should be a 512x512 pixel png file', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pwa_large_icon', to='wagtailimages.Image', verbose_name='Large Icon'),
        ),
        migrations.AlterField(
            model_name='sitesettings',
            name='pwa_icon_small',
            field=models.ForeignKey(blank=True, help_text='This icon should be a 192x192 pixel png file', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pwa_small_icon', to='wagtailimages.Image', verbose_name='Small Icon'),
        ),
    ]
